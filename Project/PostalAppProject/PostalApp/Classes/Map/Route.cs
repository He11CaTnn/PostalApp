...
namespace PostalApp
{
    ...
    {
        public static double _walkSpeed = 0.25;
        public static double _bikeSpeed = 1.5;

        // Расчет времени
        public static double metreSeconds = 0.25;
        ...
        public static string FormatDistance(double meters)
        {
            ...
            {
                double km = roundedMeters / 1000.0;
                return $"{km:0.0} км".Replace('.', ',');
            }
            else if (roundedMeters >= 1000)
            {
                double km = roundedMeters / 1000.0;
                return $"{km:0.00} км".Replace('.', ',');
            }
            else
            {
