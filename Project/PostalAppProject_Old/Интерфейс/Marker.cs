            ...
            try
            {
                ...
                if (!isSelected)
                {
                    if (buildingType.Contains("частный дом") || buildingType.Contains("не указан") || string.IsNullOrEmpty(buildingType))
                        originalBitmap = Properties.Resources.Частный_дом;
                    else if (buildingType.Contains("post office"))
                        originalBitmap = Properties.Resources.почта;
                    else if (buildingType.Contains("многоквартирный дом"))
                        originalBitmap = Properties.Resources.многоэтажный_дом;
                    else
                        originalBitmap = Properties.Resources.Здание_организаций;
                }
                else
                {
                    originalBitmap = Properties.Resources.маркер;
                }
