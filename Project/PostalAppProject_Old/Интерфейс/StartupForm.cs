...
namespace Интерфейс
{
    public partial class StartupForm : Form
    {
        ...
        private System.Windows.Forms.Timer _rateLimitTimer;
        ...
        private async Task RunStartupSequence()
        {
            ...
            string motherboardId = SecureConfig.GetMotherboardId();
        ...
        private async Task HandleDeviceAutoLogin(string motherboardId)
        {
            try
            {
                ...
                SecureConfig.ServerConfig cfg =
                    await SecureConfig.FetchConfigByMotherboardId(motherboardId);
        ...
        private async Task HandleLoginClick()
        {
            ...
            try
            {
                cfg = await SecureConfig.FetchConfigFromServer(email, password);
            }
            catch (RateLimitException ex)
            {
                ShowLoginPanel();
        ...
        private static void ApplyConfigToProgram(SecureConfig.ServerConfig cfg)
        {
